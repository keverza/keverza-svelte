...
<div class="relative z-10" aria-labelledby="slide-over-title" role="dialog" aria-modal="true" >
    ...
    <div class="fixed inset-0 overflow-hidden"on:click={()=>{isCartOpen.set(!$isCartOpen)}}>
          ...
          transition:fly={{x:400}}>
            <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
              ...
              <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
                ...
                <div class="mt-6">
                  <a href="#" class="flex items-center justify-center rounded-md border border-transparent bg-gray-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-gray-900">Checkout</a>
                </div>
                <div class="mt-6 flex justify-center text-center text-sm text-gray-500">
                  <p>
                    arba <button on:click={()=>{isCartOpen.set(!$isCartOpen)}} type="button" class="font-medium text-indigo-600 hover:text-indigo-500">Continue Shopping<span aria-hidden="true"> &rarr;</span></button>
                  </p>
